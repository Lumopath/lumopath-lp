        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://chat-assets.frontapp.com https://cdn.mouseflow.com https://js.hs-scripts.com",
